...
function Header() {
  return (
    <div className='header'> 
      ...
      <img src="../src/pictures/asd.png" height={108} width={100}/>

      <h1 className='yazi'>3/9 Царство</h1> 
      <img className='iconharita' src="../src/pictures/iconharita.png" />
      <h1 className='adres'>Набережная, 41/1, г. Березники</h1>
      <img className='telefonicon' src="../src/pictures/Group.png" alt="" />
